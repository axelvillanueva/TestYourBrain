          ...
          <div class="container">
              <div class="row justify-content-center">
                  ...
                  <div class="card col-md-4 col-sm-8 my-5" style="background: url(img/bg-117.jpg); border: solid 4px;">
                      <img class="card-img-top rounded-circle mt-3" style="align-self:center; width: 72%; height: 250px; border: #863c3c solid 4px;" src="{{Auth::user()->avatar!='no tiene'?'/storage/'.Auth::user()->avatar:'img/logo.jpg'}}" alt="Card image cap">
